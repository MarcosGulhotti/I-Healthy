...
export const Menu = () => {
  ...
  return (
    <StyledMenu>
      <li>
        <Link to='#' onClick={(e) => moveIndicator(e, 1)}
      ...
      <li>
        <Link to='#' onClick={(e) => moveIndicator(e, 2)}
      ...
      <li>
        <Link to='#' onClick={(e) => moveIndicator(e, 4)}
      ...
      <li>
        <Link to='#' onClick={(e) => moveIndicator(e, 5)}
        className={color === 5 && 'active'}
        >
          <i className={`far fa-calendar-alt ${color === 5 && 'active'}`}></i>
        </Link>
      </li>
      <StyledMarker id='marker' left={left} width={width} isProfessional={user.isProfessional}/>
    </StyledMenu>
  )
}